...
|------------------|----------------------|------------------|
| 🏴‍☠️ **[Detecting Unauthorised Admin Account Creation](https://github.com/wilbcn/BlueTeam/blob/main/Splunk-Projects/Splunk-Investigations-2.md)** | `T1098 - Account Manipulation` | Monitor and alert when a new admin account is created. Get practice with building dashboards. |
